class User:
    ...
    def describe_user(self):
        print(f"Our user is {self.first_name} {self.last_name} and they are {self.age} years"
              f" old and they are a {self.sex}")
...
admin_1 = Admin("Oise", 'Omoijuanfo',29, "male")

privileges =["Can ban""can upvote"]
